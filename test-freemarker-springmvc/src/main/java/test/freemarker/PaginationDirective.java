...
import test.common.Pager.Order;
...
public class PaginationDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		Pager pager = (Pager) FreemarkerUtil.getObjectParameter(PAGER_PARAMETER_NAME, params);
		List<String> urlList = (ArrayList<String>) FreemarkerUtil.getObjectParameter(URL_LIST_PARAMETER_NAME, params);
		Integer maxPageItemCount = FreemarkerUtil.getIntegerParameter(MAX_PAGE_ITEM_COUNT_PARAMETER_NAME, params);
		Map<String, String> parameterMap = (HashMap<String, String>) FreemarkerUtil.getObjectParameter(PARAMETER_MAP_PARAMETER_NAME, params);
		...
		if (pager != null) {
			String baseUrl = FreemarkerUtil.getStringParameter(BASE_URL_PARAMETER_NAME, params);
			...
			pageNumber = FreemarkerUtil.getIntegerParameter(PAGE_NUMBER_PARAMETER_NAME, params);
		...
		if (body != null) {
			...
			env.setVariable(PAGE_ITEM_PARAMETER_NAME, new SimpleHash(pageItem, null));
